const config = {
    ...
    "stats": [
        ...
        {
            "value": "40+ hrs",
            "label": "saved per month through automation"
        },
        {
            "value": "60% / 30%",
            "label": "processing reduction / deployment improvement"
        }
    ],
    "skills": [
        {
    ...
    "projects": [
        {
            "name": "Azure DevOps Pipeline Factory",
            "subtitle": "YAML, Python, PowerShell, IIS",
            "highlights": [
                "Reverse-engineered the organization's single existing pipeline into reusable templates for .NET applications, with parameterized artifact creation, IIS deployment, and approval controls.",
                "Launched three new pipelines and established a repeatable onboarding path for the remaining 70+ application portfolio, reducing copy-and-paste configuration and human-error risk."
            ],
            "tags": [
                "Azure DevOps",
                "YAML",
        ...
        {
            "name": "AI Operations Knowledge Library",
            "subtitle": "Jira, Confluence, SharePoint, Claude skills",
            "highlights": [
                "Built one-way content synchronization with documentation-drift detection so stale system knowledge can be identified while current operational context remains rapidly searchable.",
                "Packaged reusable Claude skills and system context to support log analysis, application troubleshooting, and Jira ticket drafting or closure without repeatedly supplying background information."
            ],
            "tags": [
                "Jira",
                "Confluence",
        ...
        {
            "name": "Environment Reliability Tooling",
            "subtitle": "IIS, Python, Go, SQL",
            "highlights": [
                "Created environment-comparison dashboards, centralized operations workflows, configuration-driven database reporting, migration utilities with dry-run support, and error-specific IIS support pages."
            ],
            "tags": [
                "IIS",
                "Python",
